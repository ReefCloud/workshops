...
%New feature
\commit{right = 1.5cm of commitshash7}{commitshash13}{color_inactive}{commitshash13}{commitscomment13}
\draw [<-,line width=3pt,draw=black!60] (commitshash7.east) -- (commitshash13.west);

%Feature complete
\commit{right = 1.5cm of commitshash13}{commitshash14}{color_commit}{commitshash14}{commitscomment14}
\draw [<-,line width=3pt,draw=black!60] (commitshash13.east) -- (commitshash14.west);

\master{below = 1cm of commitshash7} 
\branch{below = 1cm of commitshash14}{Feature} 
\HEAD{below = 0.1cm of Feature} 
\end{tikzpicture}
\end{preview}
\end{document}
