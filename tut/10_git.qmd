...
3. click the "Commit" button and you will be presented with a popup
   ...
   ![](resources/rstudio_commit2.png){width=80%}
...
10. clickV the "Commit" button
11. you might like to explore the changes associated with each file
12. enter a commit message (as in the figure below)
